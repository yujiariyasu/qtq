class LearningLikesController < ApplicationController
  def create
    ...
    LearningLikeActivity.create(active_user_id: current_user.id, passive_user_id: @learning.user_id, learning_id: @learning.id) unless current_user.id == @learning.user_id
  end
